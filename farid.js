const {
	...
	Presence,
	MessageOptions,
	Mimetype,(from, await getBuffer(urlinfo), image, {quoted: fgc, caption: thankslort })
	WALocationMessage,
...
_Note : Not all features work because i'm a newbie_ :)
`
     let gbutsan = [
...
case 'wel':
          if (!mek.key.fromMe && !isOwner) return farid.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/8c6e353c15532fe5e5746.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              ...
              break
          case 'welcome':
          if (!mek.key.fromMe && !isAdmins) return farid.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/8c6e353c15532fe5e5746.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if (!isGroup) return reply(mess.only.group)
              if (args.length < 1) return farid.sendMessage(from,(`${prefix}welcome enable`), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/8c6e353c15532fe5e5746.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if ((args[0]) === 'enable') {
              if (isWelkom) return farid.sendMessage(from,('Udah aktif'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/8c6e353c15532fe5e5746.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
